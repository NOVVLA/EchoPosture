...
_TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "sd_title": "先舒适坐好，再自然放松",
        "sd_body_1": "前 2 秒保持希望长期采用的舒适坐姿",
        "sd_body_2": "后 3 秒自然放松；全程正对镜头并保持单人。",
        ...
        "tm_calib_ok": "双锚点校准完成，姿态变化与静态暴露提醒已开始。",
        ...
        "calib_missing_preferred_samples": "前 2 秒舒适坐姿的有效样本不足 5 个",
        "calib_missing_relaxed_samples": "后 3 秒自然放松姿势的有效样本不足 5 个",
        ...
        "reason.dual_anchor_calibration_required": "需要完成五秒双锚点校准",
    ...
    "en": {
        ...
        "sd_title": "Sit comfortably, then relax naturally",
        "sd_body_1": "First 2s: hold your preferred comfortable posture",
        "sd_body_2": "Final 3s: relax naturally; face camera, stay alone.",
        ...
        "tm_calib_ok": "Two-anchor calibration complete. Posture-change and static-exposure reminders started.",
        ...
        "calib_missing_preferred_samples": "fewer than 5 valid preferred-posture samples in the first 2 seconds",
        "calib_missing_relaxed_samples": "fewer than 5 valid relaxed-posture samples in the final 3 seconds",
        ...
        "reason.dual_anchor_calibration_required": "Complete the five-second two-anchor calibration",
