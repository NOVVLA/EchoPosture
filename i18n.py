...
_TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "reason.camera_roll_measurement_abstained": "画面水平基准可能发生转动，已暂停姿态偏离和静态暴露累计",
        "reason.camera_scale_jump_measurement_abstained": "镜头距离变化，暂停姿态判定",
        "reason.head_turn_measurement_abstained": "转头时暂停姿态偏离判定",
        "reason.shared_shoulder_scale_measurement_abstained": "肩部尺度测量不稳定，已暂停姿态偏离和静态暴露累计",
    ...
    "en": {
        ...
        "reason.camera_roll_measurement_abstained": "The image reference may have rolled; posture deviation and static exposure are paused",
        ...
        "reason.shared_shoulder_scale_measurement_abstained": "Unstable shoulder-scale measurement; posture deviation and static exposure are paused",
