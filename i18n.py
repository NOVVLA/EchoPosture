...
_TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "reason.post_calibration_normal_range_validation": "正在复验校准后的个人正常姿态范围，暂不累计静态暴露",
    ...
    "en": {
        ...
        "reason.post_calibration_normal_range_validation": "Validating the post-calibration personal normal range; static exposure is paused",
