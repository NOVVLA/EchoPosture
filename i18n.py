...
_TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "debug_stage_active_detail": "两个锚点及其区间属于个人正常范围；只累计越过任一侧范围边界和小噪声带的持续偏离。",
    ...
    "en": {
        ...
        "debug_stage_active_detail": "Both anchors and their interval are normal; only sustained excursion beyond either range boundary and the small noise band accumulates.",
