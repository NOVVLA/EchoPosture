...
_TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "tm_calib_ok": "双锚点校准完成，正式监测已开始。两个锚点之间属于个人正常姿态范围。",
        ...
        "reason.camera_scale_jump_measurement_abstained": "镜头距离变化，暂停姿态判定",
        "reason.head_turn_measurement_abstained": "转头时暂停姿态偏离判定",
        "reason.posture_features_unavailable": "当前没有足够的姿态变化指标",
        "reason.posture_evidence_inconclusive": "姿态证据不一致，暂不判定为偏离",
        ...
        "debug_stage_preferred_title": "阶段 1/2 · 保持坐直姿势",
        "debug_stage_preferred_detail": "完整 5 秒采样中；保持你希望长期采用的正确舒适坐姿，现在不要放松。阶段 1 会显示倒计时。",
        ...
        "debug_stage_relaxed_detail": "自然放松姿势静默采集中；此阶段不显示倒计时，请保持自然放松，直到画面明确显示校准完成。",
        "debug_stage_active_title": "双锚点就绪 · 正式监测中",
        "debug_stage_active_detail": "两个锚点之间属于个人正常范围；只累计越过自然放松边界和噪声带的持续偏离。",
        "debug_stage_failed_title": "双锚点校准失败",
        "debug_stage_failed_detail": "查看下方失败原因后重新尝试。",
        "debug_stage_camera_preferred_banner": "阶段 1/2 · 坐直姿势采集中\n保持你希望长期采用的正确舒适坐姿",
        "debug_stage_camera_transition_banner": "阶段切换 · 现在可以自然放松\n过渡期间不采样",
        "debug_stage_camera_relaxed_banner": "阶段 2/2 · 自然放松姿势采集中\n保持自然放松，直到显示校准完成",
    ...
    "en": {
        ...
        "tm_calib_ok": "Two-anchor calibration is complete and monitoring is active. The interval between both anchors is your personal normal posture range.",
        ...
        "reason.camera_scale_jump_measurement_abstained": "Camera scale changed; posture measurement paused",
        ...
        "reason.posture_evidence_inconclusive": "Posture evidence is inconsistent; no deviation is asserted",
        ...
        "debug_stage_preferred_title": "Stage 1/2 · Hold upright posture",
        "debug_stage_preferred_detail": "Keep the correct comfortable posture you want to use for the full 5 seconds; do not relax yet. Stage 1 shows a countdown.",
        ...
        "debug_stage_camera_relax_prompt": "RELAX NATURALLY NOW\nThe next stage remains visible and measures for about 5 seconds",
        "debug_stage_relaxed_title": "Stage 2/2 · Hold natural relaxation",
        "debug_stage_relaxed_detail": "Silently measuring the relaxed posture; there is no countdown in this stage. Remain naturally relaxed until completion is shown.",
        "debug_stage_active_title": "Two anchors ready · Monitoring active",
        "debug_stage_active_detail": "The interval between both anchors is normal; only sustained excursion beyond the relaxed boundary and noise band accumulates.",
        "debug_stage_failed_title": "Two-anchor calibration failed",
        "debug_stage_failed_detail": "Review the failure below, then try again.",
        "debug_stage_camera_preferred_banner": "STAGE 1/2 · UPRIGHT POSTURE SAMPLING\nHold the correct comfortable posture you want to use",
        "debug_stage_camera_transition_banner": "STAGE CHANGE · RELAX NATURALLY NOW\nTransition samples are ignored",
        "debug_stage_camera_relaxed_banner": "STAGE 2/2 · RELAXED POSTURE SAMPLING\nRemain naturally relaxed until completion is shown",
