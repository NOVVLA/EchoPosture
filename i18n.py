...
_TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "debug_stage_preferred_detail": "完整 5 秒采样中；保持你希望长期采用的正确舒适坐姿，现在不要放松。",
        ...
        "debug_stage_relaxed_detail": "约 5 秒采样中；保持自然放松，直到画面明确显示校准完成。",
    ...
    "en": {
        ...
        "debug_stage_preferred_detail": "Keep the correct comfortable posture you want to use for the full 5 seconds; do not relax yet.",
        ...
        "debug_stage_relaxed_detail": "About 5 seconds of sampling is active; remain naturally relaxed until completion is shown.",
