...
_TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "calib_missing_calibration_not_started": "校准流程未正常启动",
        "calib_missing_transition_invalid": "校准阶段切换无效",
        "calib_missing_target_lock_failed": "无法锁定监测目标",
        "calib_missing_profile_apply_failed": "校准档案应用失败",
    ...
    "en": {
        ...
        "calib_missing_calibration_not_started": "calibration was not started",
        "calib_missing_transition_invalid": "invalid calibration stage transition",
        "calib_missing_target_lock_failed": "failed to lock the monitoring target",
        "calib_missing_profile_apply_failed": "failed to apply the calibration profile",
