...
_TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "tm_calib_relax_now": "舒适坐姿测量完成，现在可以自然放松。接下来将静默测量约 5 秒。",
        "tm_calib_ok": "双锚点校准完成。请恢复希望长期采用的舒适坐姿；稳定后自动开始监测。",
        "tm_calib_fail_startup": "校准失败：{details}。请正对摄像头，并保持画面中只有一个人。",
        "tm_recal_ok": "双锚点重新校准完成。",
        ...
        "calib_missing_relaxed_samples": "静默放松姿势阶段（含有限延长）的有效样本不足 5 个",
        ...
        "calib_missing_no_feature_separates_above_mdc": "两个锚点的差异未超过测量噪声",
        ...
        "status.TARGET_OCCLUDED": "目标暂时遮挡",
        "status.TARGET_REACQUIRING": "正在重新获取目标",
        ...
        "reason.target_occluded": "目标暂时被遮挡",
        "reason.target_reacquiring": "正在重新获取目标",
        "reason.target_missing_observing_s": "目标缺失观察秒数",
        "reason.target_missing_candidate_present": "目标缺失但有候选人",
        ...
        "reason.post_calibration_return_to_preferred": "校准完成，请回到希望长期采用的舒适坐姿；当前不累计静态暴露",
        "reason.preferred_posture_monitoring_activated": "舒适坐姿已稳定，姿态变化与静态暴露监测已开始",
        "reason.activity_moving_exposure_paused": "运动中，静态暴露暂停累计",
        "reason.camera_drift_recalibration_required": "镜头位置可能变化，需要重新校准",
        "reason.head_turn_measurement_abstained": "转头时暂停姿态偏离判定",
        "reason.posture_features_unavailable": "当前没有足够的姿态变化指标",
        "reason.measurement_quality_low": "测量质量不足，暂不干预",
        "reason.within_personal_posture_range": "接近个人舒适姿态锚点",
        ...
        "debug_dual_calib_reentry": "校准完成：请回到舒适坐姿并稳定约 2 秒；激活前不会累计静态暴露。",
        "debug_dual_calib_active": "舒适坐姿已稳定，正式监测已经激活。",
        "debug_stage_idle_title": "校准未运行 · IDLE",
        "debug_stage_idle_detail": "完整双锚点按钮会依次测试舒适、过渡、放松和回归激活。",
        "debug_stage_badge_idle": "--",
        "debug_stage_badge_preferred": "1/2",
        "debug_stage_badge_transition": "放松",
        "debug_stage_badge_relaxed": "2/2",
        "debug_stage_badge_reentry": "回正",
        "debug_stage_badge_active": "监测",
        "debug_stage_badge_failed": "重试",
        "debug_stage_preferred_title": "阶段 1/2 · 保持舒适坐姿",
        "debug_stage_preferred_detail": "可见 5 秒采样中；现在不要放松。",
        "debug_stage_transition_title": "切换阶段 · 现在可以自然放松",
        "debug_stage_transition_detail": "约 1 秒稳定期，不采集任何锚点样本。",
        "debug_stage_camera_relax_prompt": "现在可以自然放松\n下一阶段将静默测量约 5 秒",
        "debug_stage_relaxed_title": "阶段 2/2 · 保持自然放松",
        "debug_stage_relaxed_detail": "静默采样中；尚未开始正式监测。",
        "debug_stage_reentry_title": "校准完成 · 请回到舒适坐姿",
        "debug_stage_reentry_detail": "稳定约 2 秒后开始监测；此时不累计静态暴露。",
        "debug_stage_active_title": "双锚点就绪 · 正式监测中",
        "debug_stage_active_detail": "现在只累计超过个人噪声带的持续姿态偏离。",
        "debug_stage_failed_title": "双锚点校准失败",
        "debug_stage_failed_detail": "查看下方失败原因后重新尝试。",
    ...
    "en": {
        ...
        "tm_calib_relax_now": "Preferred-posture measurement is complete. You may relax naturally now; silent measurement continues for about 5 seconds.",
        "tm_calib_ok": "Two-anchor calibration complete. Return to your preferred comfortable posture; monitoring starts after it is stable.",
        "tm_calib_fail_startup": "Calibration failed: {details}. Face the camera and keep only one person in view.",
        "tm_recal_ok": "Two-anchor re-calibration complete.",
        ...
        "calib_missing_relaxed_samples": "fewer than 5 valid samples in the silent relaxed stage, including its bounded extension",
        ...
        "calib_missing_no_feature_separates_above_mdc": "anchor separation did not exceed measurement noise",
        ...
        "status.TARGET_OCCLUDED": "Target occluded",
        "status.TARGET_REACQUIRING": "Reacquiring target",
        ...
        "reason.target_occluded": "Target temporarily occluded",
        "reason.target_reacquiring": "Reacquiring target",
        "reason.target_missing_observing_s": "Target missing observed seconds",
        "reason.target_missing_candidate_present": "Target missing with candidate present",
        ...
        "reason.post_calibration_return_to_preferred": "Calibration complete. Return to your preferred comfortable posture; static exposure is not accumulating yet",
        "reason.preferred_posture_monitoring_activated": "Preferred posture is stable; posture-change and static-exposure monitoring has started",
        "reason.activity_moving_exposure_paused": "Moving; static-exposure accumulation is paused",
        "reason.camera_drift_recalibration_required": "Camera position may have changed; recalibration is required",
        "reason.head_turn_measurement_abstained": "Posture-change estimation paused while the head is turned",
        "reason.posture_features_unavailable": "Not enough posture-change features are available",
        "reason.measurement_quality_low": "Measurement quality is too low for intervention",
        "reason.within_personal_posture_range": "Close to the personal preferred-posture anchor",
        ...
        "debug_metric_risk": "Deviation / exposure / confidence",
        ...
        "debug_dual_calib_reentry": "Calibration complete: return to the preferred posture and hold for about 2 seconds; exposure stays paused until activation.",
        "debug_dual_calib_active": "Preferred posture is stable; production monitoring is active.",
        "debug_stage_idle_title": "Calibration idle",
        "debug_stage_idle_detail": "The full two-anchor control tests preferred, transition, relaxed, and monitoring activation states.",
        "debug_stage_badge_idle": "--",
        "debug_stage_badge_preferred": "1/2",
        "debug_stage_badge_transition": "RELAX",
        "debug_stage_badge_relaxed": "2/2",
        "debug_stage_badge_reentry": "RETURN",
        "debug_stage_badge_active": "LIVE",
        "debug_stage_badge_failed": "RETRY",
        "debug_stage_preferred_title": "Stage 1/2 · Hold preferred posture",
        "debug_stage_preferred_detail": "Visible 5-second sampling is active; do not relax yet.",
        "debug_stage_transition_title": "Stage change · Relax naturally now",
        "debug_stage_transition_detail": "About 1 second of settling; no anchor samples are collected.",
        "debug_stage_camera_relax_prompt": "RELAX NATURALLY NOW\nThe next stage measures silently for about 5 seconds",
        "debug_stage_relaxed_title": "Stage 2/2 · Hold natural relaxation",
        "debug_stage_relaxed_detail": "Silent sampling is active; monitoring has not started yet.",
        "debug_stage_reentry_title": "Calibration complete · Return to preferred",
        "debug_stage_reentry_detail": "Monitoring starts after about 2 stable seconds; exposure remains paused until then.",
        "debug_stage_active_title": "Two anchors ready · Monitoring active",
        "debug_stage_active_detail": "Only sustained deviation beyond the personal noise band now accumulates.",
        "debug_stage_failed_title": "Two-anchor calibration failed",
        "debug_stage_failed_detail": "Review the failure below, then try again.",
