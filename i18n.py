...
_TEXTS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "status.TARGET_REACQUIRING": "兼容模式正在重新匹配目标",
        ...
        "reason.target_reacquiring": "兼容模式正在重新匹配目标",
    ...
    "en": {
        ...
        "status.TARGET_REACQUIRING": "Compatibility mode is rematching the target",
        ...
        "reason.target_reacquiring": "Compatibility mode is rematching the target",
